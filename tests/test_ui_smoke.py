...
class UISmokeTests(unittest.TestCase):
    ...
    def test_pyside_stylesheet_contains_hover_and_pressed_feedback(self) -> None:
        ...
        self.assertIn("max-width: 22px", stylesheet)
        self.assertIn("max-height: 20px", stylesheet)
    ...
    def test_pyside_search_creation_dialog_generates_and_applies_candidates(self) -> None:
        ...
        self.assertIn("QStyle.StandardPixmap.SP_TitleBarMinButton", source)
        self.assertIn("QStyle.StandardPixmap.SP_TitleBarMaxButton", source)
        self.assertIn("QStyle.StandardPixmap.SP_TitleBarCloseButton", source)
        ...
        self.assertIn("self.target.setMinimumSize(QSize(840, 520))", source)
        ...
        self.assertIn("button.setIconSize(QSize(12, 12))", source)
        ...
        self.assertIn("self.window.resize(900, 560)", source)
